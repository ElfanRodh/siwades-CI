...
<html>
  ...
  <body>
    ...
    <p style="text-align: center"> <strong>Tabel Anggota Keluarga</strong></p>
    <br><br>
    <table style="width: 100%; border: 1; border-collapse: collapse;">
      ...
      <tr>
        ...
        <td>
          <?php
            if ($row->nik == $kk['kepala_keluarga']) {
              echo "<strong><i>Kepala Keluarga</i></strong>";
            } else {
              echo "<i>Anggota Keluarga</i>";
            }
           ?>         
        </td>
